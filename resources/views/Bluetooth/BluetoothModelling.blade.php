...
@auth
    ...
    <body class="body">
        <div class='loggedInBody'>
            ...
            <div id="preload">
                ...
                <img src="{{ asset('../Images/Data/L5.png') }}" width="1" height="1" alt="Image 01" />
                <img src="{{ asset('../Images/Data/L6.png') }}" width="1" height="1" alt="Image 01" />
                <img src="{{ asset('../Images/Data/L7.png') }}" width="1" height="1" alt="Image 01" />
                <img src="{{ asset('../Images/Data/L8.png') }}" width="1" height="1" alt="Image 01" />

                <img src="{{ asset('../Images/Data/PDA1.png') }}" width="1" height="1" alt="Image 01" />
                <img src="{{ asset('../Images/Data/PDA2.png') }}" width="1" height="1" alt="Image 01" />
                <img src="{{ asset('../Images/Data/PDA3.png') }}" width="1" height="1" alt="Image 01" />
                <img src="{{ asset('../Images/Data/PDA4.png') }}" width="1" height="1" alt="Image 01" />
                <img src="{{ asset('../Images/Data/PDA5.png') }}" width="1" height="1" alt="Image 01" />
                <img src="{{ asset('../Images/Data/PDA6.png') }}" width="1" height="1" alt="Image 01" />
            ...
            <form class='modelling'>
                ...
                <div class="row mt-2 text-center border-0">
                    <div id="dx" class="col-10 border border-0"
                        ...
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w1" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w2" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w3" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w4" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w5" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w6" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w7" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w8" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w9" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w10" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w11" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w12" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w13" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w14" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w15" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w16" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w17" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w18" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w19" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                            id="w20" width="32" height="32" />
                        <img src="{{ asset('../Images/Data/wifi.png') }}" class="wifi invisible position-absolute zidx1"
                ...
                <div id="grp" class="d-none">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3 col-form-label" style="color:Red" id="dispscatternet"></div>

                    </div>
                    <div class="row">
                        <div class="col-3 col-form-label" style="color:Red">No of Piconet</div>
                        <div class="col-3 col-form-label" style="color:Red" id="disppiconet"></div>

                    </div>
                    <div class="row">
                        <div class="col-3 col-form-label" style="color:Red">No of Nodes</div>
                        <div class="col-3 col-form-label" style="color:Red" id="dispnodes"></div>
                    </div>
                </div>
            </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            let macAddresses = ['2C:54:91:88:C9:E3', '00:1B:44:11:3A:B7', 'B1:A4:1B:A7:35:F8', '15:CA:23:E5:FA:38',
                '26:2C:47:7A:28:F4', '30:EF:7F:8E:AF:FF', 'FD:FA:C0:DD:45:80', '6F:03:10:E8:42:6B',
                '25:10:18:B6:32:57', '89:9B:84:F4:CB:E5', '8B:52:3F:D9:93:BA', 'F7:6F:1D:55:CF:4F',
                '4E:8B:9A:3C:9C:0F', '2F:50:3A:5D:AE:8F', '3E:7E:C0:A4:A8:B5', '22:D1:4F:89:B2:62',
                'A9:F6:8F:D0:E8:ED', '40:95:37:03:A9:CD', '6F:DD:F8:9A:F9:18', '18:66:91:DA:47:69',
                '5C-56-FD-0D-EB-DE'
            ]
            ...
            displayMacAddress = function(evt) {
                ...
                if (evt.offsetX >= xList[listIdx1] + ax && evt.offsetX <= xList[listIdx1] + ax + 64 && evt
                    .offsetY >= yList[listIdx1] && evt.offsetY <= yList[listIdx1] + 64) {
                    ...
                    if (evt.offsetX >= xList[listIdx1] + ax && evt.offsetX <= xList[listIdx1] + ax + 64 && evt
                        ...
                        if (evt.offsetX >= xList[listIdx1] + ax && evt.offsetX <= xList[listIdx1] + ax + 64 &&
                            evt.offsetY >= yList[listIdx1] && evt.offsetY <= yList[listIdx1] + 64) {
                            ...
                            if (evt.offsetX >= xList[listIdx1] + ax && evt.offsetX <= xList[listIdx1] + ax +
                                64 && evt.offsetY >= yList[listIdx1] && evt.offsetY <= yList[listIdx1] + 64) {
                                ...
                                if (evt.offsetX >= xList[listIdx1] + ax && evt.offsetX <= xList[listIdx1] + ax +
                                    ...
                                    if (evt.offsetX >= xList[listIdx1] + ax && evt.offsetX <= xList[listIdx1] +
                                        ax + 64 && evt.offsetY >= yList[listIdx1] && evt.offsetY <= yList[
                                            listIdx1] + 64) {

                                        if (nodesCount >= (listIdx1 + 2))
                                            $("#slave" + (listIdx1 + 1)).removeClass("d-none").addClass(
                                                "d-block");
                                    } else {
                                        $("#slave" + (listIdx1 + 1)).removeClass("d-block").addClass("d-none");
                                        listIdx1++;
                                        ...
                                        if (evt.offsetX >= xList[listIdx1] + ax && evt.offsetX <= xList[
                                                listIdx1] + ax + 64 && evt.offsetY >= yList[listIdx1] && evt
                                            .offsetY <= yList[listIdx1] + 64) {

                                            if (nodesCount >= (listIdx1 + 2))
                                                $("#slave" + (listIdx1 + 1)).removeClass("d-none").addClass(
                                                    "d-block");
                                        } else {
                                            $("#slave" + (listIdx1 + 1)).removeClass("d-block").addClass(
                                                "d-none");
                                            ...
                                            if (evt.offsetX >= xList[listIdx1] + ax && evt.offsetX <= xList[
                                                ...
                                                if (nodesCount >= (listIdx2 + 2))
                                                    $("#slave" + (listIdx2 + 1)).removeClass("d-none").addClass(
                                                        "d-block");
                                            } else {
                                                $("#slave" + (listIdx2 + 1)).removeClass("d-block").addClass(
                                                    "d-none");
                                                listIdx1++; // listIdx1 = 1
                                                listIdx2++; // listIdx2 = 8
                                                ax = 310;
                                                if (evt.offsetX >= xList[listIdx1] + ax && evt.offsetX <= xList[
                                                        listIdx1] + ax + 64 && evt.offsetY >= yList[listIdx1] &&
                                                    evt.offsetY <= yList[listIdx1] + 64) {

                                                    if (nodesCount >= (listIdx2 + 2))
                                                        $("#slave" + (listIdx2 + 1)).removeClass("d-none")
                                                        .addClass("d-block");
                                                } else {
                                                    $("#slave" + (listIdx2 + 1)).removeClass("d-block")
                                                        .addClass("d-none");
                                                    listIdx1++; // listIdx1 = 2
                                                    listIdx2++; // listIdx2 = 9
                                                    ax = 310;
                                                    if (evt.offsetX >= xList[listIdx1] + ax && evt.offsetX <=
                                                        xList[listIdx1] + ax + 64 && evt.offsetY >= yList[
                                                            listIdx1] && evt.offsetY <= yList[listIdx1] + 64) {
                                                        ...
                                                        ax = 310;
                                                        if (evt.offsetX >= xList[listIdx1] + ax && evt
                                                            .offsetX <= xList[listIdx1] + ax + 64 && evt
                                                            .offsetY >= yList[listIdx1] && evt.offsetY <= yList[
                                                                listIdx1] + 64) {

                                                            if (nodesCount >= (listIdx2 + 2))
                                                                $("#slave" + (listIdx2 + 1)).removeClass(
                                                            ...
                                                            if (evt.offsetX >= xList[listIdx1] + ax && evt
                                                                .offsetX <= xList[listIdx1] + ax + 64 && evt
                                                                .offsetY >= yList[listIdx1] && evt.offsetY <=
                                                                yList[listIdx1] + 64) {
                                                                ...
                                                                if (evt.offsetX >= xList[listIdx1] + ax && evt
                                                                    ...
                                                                    if (evt.offsetX >= xList[listIdx1] + ax &&
                                                                        evt.offsetX <= xList[listIdx1] + ax +
                                                                        64 && evt.offsetY >= yList[listIdx1] &&
                                                                        evt.offsetY <= yList[listIdx1] + 64) {
                                                                        ...
                                                                        $("#slave" + (listIdx2 + 1))
                                                                            .removeClass("d-block").addClass(
                                                                                "d-none");

                                                                        listIdx1++; // listIdx1 = 1
                                                                        listIdx2++; // listIdx2 = 14
                                                                        ax = 310 * 2;
                                                                        if (evt.offsetX >= xList[listIdx1] +
                                                                            ax && evt.offsetX <= xList[
                                                                                listIdx1] + ax + 64 && evt
                                                                            .offsetY >= yList[listIdx1] && evt
                                                                            .offsetY <= yList[listIdx1] + 64) {
                                                                            ...
                                                                            if (evt.offsetX >= xList[listIdx1] +
                                                                                ax && evt.offsetX <= xList[
                                                                                    listIdx1] + ax + 64 && evt
                                                                                .offsetY >= yList[listIdx1] &&
                                                                                evt.offsetY <= yList[listIdx1] +
                                                                                64) {
                                                                                if (nodesCount >= (listIdx2 +
                                                                                        2))
                                                                                    $("#slave" + (listIdx2 + 1))
                                                                                    .removeClass("d-none")
                                                                                    .addClass("d-block");
                ...
                if (evt.offsetX >= nx1 && evt.offsetX <= nx1 + ax + 64 && evt.offsetY >= ny1 && evt.offsetY <=
                    ny1 + 64) {
                    ...
                    if (evt.offsetX >= nx1 + ax && evt.offsetX <= nx1 + ax + 64 && evt.offsetY >= ny1 && evt
                        .offsetY <= ny1 + 64 && scatternets >= 2) {
                        //$("#masterinfo").removeClass("d-none").addClass("d-block");
            ...
            $('#rounddata2').css('transform', 'translate(' + (xList[0] + 65 + (310 * 1)) + 'px,' + (yList[0] + 45) +
                'px)');
            $('#rounddata3').css('transform', 'translate(' + (xList[0] + 65 + (310 * 2)) + 'px,' + (yList[0] + 45) +
                'px)');
            ...
            createNodes = function(scatternetIndex, sx1, sy1, xAxis, imgIndex) {
                ...
                if (scatternetIndex < 2) {
                    for (var idx = 0; idx < nodes; idx++) {
                        ...
                        if (idx == 0) {
                            ...
                            if (idx == 2 && scatternetIndex == 1 && scatternets == 3) {
                                ...
                                ctx.font = "bold 15px Arial";
                                ctx.fillStyle = "#1b1bd6"
                                ctx.fillText("Master-" + masterNbr, xList[idx - 1] + xAxis + 15, yList[idx -
                                    1] + 85, w, h);
                                masterNbr++;
                                ...
                                if (xAxis == 0) {
                                    ...
                                    ctx.font = "bold 15px Arial";
                                    ctx.fillStyle = "#1b1bd6"
                                    ctx.fillText("Slave-" + slaveNbr, xList[idx - 1] + xAxis + 10, yList[idx -
                                        1] + 78, w, h);
                                    ...
                                    if (idx != 6) {
                                        ...
                                        if (slaveNbr >= 7)
                                            slaveNbr = 1;
                                        ctx.fillText("Slave-" + slaveNbr, xList[idx - 1] + xAxis + 15, yList[
                                            idx - 1] + 78, w, h);
                    ...
                    for (var idx = 0; idx < nodes; idx++) {
                        ...
                        ctx.fillStyle = "#1b1bd6"
                        if (idx != 5) {
                            ctx.fillText("Slave-" + slaveNbr, xList[idx - 1] + xAxis + xThres[idx - 1] - 30,
                                yList[idx - 1] + yThres[idx - 1] + tmp_ythres, w, h);
                        } else {
                            ctx.fillText("Slave-" + slaveNbr, xList[idx - 1] + xAxis + xThres[idx - 1] - 22,
                                yList[idx - 1] + yThres[idx - 1] + tmp_ythres + 19, w, h);
                        }
            ...
            insertMacAddress = function() {
                ...
                for (let m = 0; m < macAddresses.length; m++) {
                    if (m < 7) {
                        ...
                        if (m == 2) {
                            $("#slave" + (m + 1)).html(macAddresses[m]).css("left", xList[listIdx] + 60).css(
                                "top", yList[listIdx] - 15);
                        } else {
                            if (m == 4) {
                                $("#slave" + (m + 1)).html(macAddresses[m]).css("left", xList[listIdx] - 10)
                                    .css("top", yList[listIdx] - 20);
                            } else {
                                $("#slave" + (m + 1)).html(macAddresses[m]).css("left", xList[listIdx] + 40)
                                    .css("top", yList[listIdx] - 20);
                            }
                    ...
                    if (m >= 7 && m < 13) {
                        ...
                        if (m + 1 == 10) {
                            $("#slave" + (m + 1)).html(macAddresses[m]).css("left", xList[listIdx] + 60 + 310)
                                .css("top", yList[listIdx] - 17);
                        } else {
                            if (m + 1 == 12) {
                                $("#slave" + (m + 1)).html(macAddresses[m]).css("left", xList[listIdx] + 10 +
                                    310).css("top", yList[listIdx] - 17);
                            } else {
                                $("#slave" + (m + 1)).html(macAddresses[m]).css("left", xList[listIdx] + 40 +
                                    310).css("top", yList[listIdx] - 17);
                            }
                    ...
                    if (m >= 13) {
                        ...
                        if (m + 1 == 18) {
                            $("#slave" + (m + 1)).html(macAddresses[m]).css("left", xList[listIdx] + 35 + (310 *
                                2)).css("top", yList[listIdx] + 3);
                        } else {
                            $("#slave" + (m + 1)).html(macAddresses[m]).css("left", xList[listIdx] + 40 + (310 *
                                2)).css("top", yList[listIdx] - 17);
                        }
            ...
            $("#btnGenerate").click(function() {
                ...
                $("#masterpico1, #masterpico2, #masterpico3 #hovertext, #txtz").removeClass("d-block")
                    .addClass("d-none");
                $("#masterinfo1").removeClass("d-block").addClass("d-none");
                wifiIdx = 1;
            ...
            dataAnimate1 = function() {
                ...
                if (!pause) {
                    ...
                    if (actualNodes >= 10)
                        ...
                        $("#rounddata2").html("D").css("transform", 'translate(' + (left + (310 * 1)) + 'px, ' +
                            top + 'px)');

                    if (scatternets >= 3) {
                        //$("#rounddata3").html("D").css("left", left3 + (310 * 2)).css("top", top3);
                        $("#rounddata3").html("D").css("transform", 'translate(' + (left3 + (310 * 2)) +
                            'px, ' + top3 + 'px)');
            ...
            $("#btnPlay").click(function() {
                ...
                $('#rounddata2').css('transform', 'translate(' + (xList[0] + 65 + (310 * 1)) + 'px,' + (
                    yList[0] + 45) + 'px)');
                $('#rounddata3').css('transform', 'translate(' + (xList[0] + 65 + (310 * 2)) + 'px,' + (
                    yList[0] + 45) + 'px)');
                dataAnimate1();
            ...
            $("#btnStop").click(function() {
                ...
                if (play) {
                    ...
                    $("#masterinfo1").removeClass("d-none").addClass("d-block");
                }

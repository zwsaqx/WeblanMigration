            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="normalText"
                ...
                <tr>
                    <td>
                        ...
                        <P>
                            <img src="{{ asset('Images/Bluetooth/Scenario2_BT.png') }}" width="600" height="500"
                                align="top">
                ...
                <tr>
                    <td>
                        ...
                        <P><span class="redText">
                                <!--Text here-->
                            </span> <img src="{{ asset('Images/Bluetooth/Scenario3_BT.png') }}" width="758"
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="normalText"
                ...
                <tr>
                    <td>
                        ...
                        <ul>
                            <li>Lower cost: Lower the deployment costs due to no need of wired control, and reduced
                                maintenance
                                cost
                            </li>
                        ...
                        <P><span class="redText">
                                <!--Text here-->
                            </span> <img src="{{ asset('Images/Bluetooth/Scenario4_BT.png') }}" width="881"
                                height="625" align="top"></P>

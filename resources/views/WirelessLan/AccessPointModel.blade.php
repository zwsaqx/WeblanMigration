...
@section('content')
    ...
    <table width="747" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td> </td>
            <td colspan="4" rowspan="5" valign="bottom"><img src="{{ asset('Images/Data/Dedicated Servers.png') }}"
                    width="296" height="259" /></td>
            <td> </td>
            <td colspan="4" align="right" valign="bottom"><img src="{{ asset('Images/Data/BSS.png') }}" alt=""
                    width="311" height="27" /></td>
            <td> </td>
            <td width="96" rowspan="11" align="center" valign="middle"><img src="{{ asset('Images/Data/ESS.png') }}"
                    width="31" height="665" /></td>
        </tr>
        <tr>
            <td width="39"> </td>
            <td width="39"> </td>

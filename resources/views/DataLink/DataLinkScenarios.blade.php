            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="normalText">
                <tr>
                    <td> <span class="darkBlueTextJumbo"><a name="Scenario1"></a>Scenario 1</span><br />
                        An international company deploys VPN (Virtual Private Network) to enhance security for remote staff.
                        Few
                        staff reports that they cannot access to VPN service regardless of all changes made by
                        administrator.
                        From system logs, it appears that VPN tunnels are reinitialised after short period of time, making
                        connections eventually times out.

                        <P><span class="redText">Question: </span>How the administrator can assure a stable VPN connection?
                        </P>
                        </p>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="normalText">
                <tr>
                    <td> <span class="darkBlueTextJumbo"><a name="Scenario2"></a>Scenario 2</span><br />
                        ...
                        customers still cannot get optimal speed despite getting 5 bars in their laptops. The company has
                        increased Wi-Fi access point density, configured access point with 802.11n mode, and installed more
                        ...
                        <p>
                            <font size="2"><i>Source:
                                ...
                                <p>There are only 11 usable channels. In residential area, it is likely that channels 1, 6,
                                    and
                                    11 which are the default channels for APs are not changed. When two or more APs are all
                                    set
                ...
                <tr>
                    <td>
                        <p><span class="darkBlueTextJumbo"><a name="Scenario3"></a>Scenario 3</span><br />
                            ...
                            system
                            in the office must synchronise its data with the central database at real-time to ensure normal
                        ...
                        <P><span class="redText">Hint: </span>Revise the concept of Data Transmission and Data Link Layer.
                        </p>
                        <br />
                        <a href="#Top">[To Top]</a>
                    </td>
                ...
                <tr>
                    <td>
                        <p><span class="darkBlueTextJumbo"><a name="Scenario4"></a>Scenario 4</span><br />
                            An institute has a lab for student which consists of about 50 PCs. As growing demands of laptop
                        ...
                        <P><span class="redText">Hint: </span> Broadcast domain might be too big for current infrastructure
                            to
                            handle.</P>

                ...
                <tr>
                    <td> <span class="darkBlueTextJumbo"><a name="Scenario2"></a>Scenario 2</span><br />
                        ...
                        <p>The User of PC 1 reports that he cannot retrieve files from PC 3. You as the administrator are
                            required to troubleshoot the problem. The list of IP addresses of each device has been emailed
                            to
                            you</p>
                        ...
                        <P><span class="redText">Question: </span>Identify the problem and list necessary step to allow user
                            on
                ...
                <tr>
                    <td>
                        ...
                        <p>Network administrator of ABC Company is requested to provide remote access for a staff. The staff
                            wants to access to his work PC and local web server in the headquarter office. Company ABC is
                            using
                            an Internet package which includes with a static IP address: 120.135.4.88. The staff only has
                            dynamic IP addresses.</p>

                        <P><span class="redText">Question:</span> What sort of configurations can the administrator do to
                            allow
                ...
                <tr>
                    <td>
                        ...
                        <p>The ABC Company has deployed RIP as their routing protocol. Recently, a User from Branch A
                            ...
                            As the lead administrator for the ABC Company, you are reported from another admin on your team
                            that
                            he believes the problem lies with the RIP configuration itself and he has emailed you routing
                            tables
                            for all routers in the network. </p>
                        <img src="{{ asset('Images/TCPIP/router_table.png') }}" width="600" height="400"
                            align="top">
                        <br />
                        </p>

                        <P><span class="redText">Question: </span>Identify the error and suggest necessary actions to allow
                            the

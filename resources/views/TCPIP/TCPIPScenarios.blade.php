        ...
        <tr>
            <td> <span class="darkBlueTextJumbo"><a name="Scenario1"></a>Scenario 1</span><br />
                ...
                <p>A small ISP called Freedom Internet has 3 branches namely Headquarter, Branch A and Branch B. The
                    Headquarter is connected to each of its branches using high speed WAN serial connections. Branch A
                ...
                <p>You are currently hired by Freedom Internet to help them design an IP addressing scheme and assuming
                    you are given the network address of 192.168.20.0/24 to start off with. You are also given a list of
                ...
                <P><span class="redText">Topology: </span><img src="{{ asset('Images/TCPIP/TCPIP_Scenario1.png') }}"
                        width="600" height="500" align="top"></P>
        ...
        <tr>
            <td> <span class="darkBlueTextJumbo"><a name="Scenario2"></a>Scenario 2</span><br />
                ...
                <p>Given the below topology:</p>
                    ...
                    height="500">
                <p>The User of PC 1 reports that he cannot retrieve files from PC 3. You as the administrator are
                    required to troubleshoot the problem. The list of IP addresses of each device has been emailed to
                    you</p>
                ...
                <P><span class="redText">Question: </span>Identify the problem and list necessary step to allow user on
                    PC 1 to communicate to user on PC 3 and vice versa.</P>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="normalText">
        <tr>
            <td>
                ...
                <p>Network administrator of ABC Company is requested to provide remote access for a staff. The staff
                    wants to access to his work PC and local web server in the headquarter office. Company ABC is using
                    an Internet package which includes with a static IP address: 120.135.4.88. The staff only has
                    dynamic IP addresses.</p>

                <P><span class="redText">Question:</span> What sort of configurations can the administrator do to allow
                    staff to remotely access their work PC ?</P>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="normalText">
        <tr>
            <td>
                ...
                <p>The ABC Company has deployed RIP as their routing protocol. Recently, a User from Branch A reports
                    that he cannot access and retrieve files from the Remote Server located on a remote Branch.
                    As the lead administrator for the ABC Company, you are reported from another admin on your team that
                    he believes the problem lies with the RIP configuration itself and he has emailed you routing tables
                    for all routers in the network. </p>
                <img src="{{ asset('Images/TCPIP/router_table.png') }}" width="600" height="400" align="top">
                <br />
                </p>

                <P><span class="redText">Question: </span>Identify the error and suggest necessary actions to allow the
                    User access to the Remote Server.</P>
        ...
        <tr>
            <td>
                <p><span class="darkBlueTextJumbo"><a name="Exercise2"></a>Exercise 2</span><br />
                    ...
                    <span class="redText">Draw a network topology that is compatible with the routing table
                        above.</span>
                    <br>
                    <br />
                    <a href="#Top">[To Top]</a>

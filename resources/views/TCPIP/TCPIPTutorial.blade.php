...
@auth
    ...
    <body class="body">
        <div class='loggedInBody'>
            <h1 class="header1">TCP/IP Tutorial</h1>
            <h3>Learning outcomes</h3>
            <p>By the end of this tutorial, you will be able to:</p>
            <ol type="1">
                <li>Define the following key terms related to TCP/IP Networking: Address Resolution Protocol, Application
                    Layer,
                    broadcast domain, collision domain, convergence, default route, domain name system, EIGRP, gateway,
                    frame,
                    hop limit, IPv4, MAC address.</li>
                <li>Using Network Simulator to create your own network, assign IP address for PCs, router interfaces and
                    observe

...
if ($_SESSION["star"]["type"] == "star") {
    // Logical Star
    $type = "star";
} else if ($_SESSION["star"]["type"] == "bus") {
    // Logical Bus
    $type = "bus";
} else if ($_SESSION["star"]["type"] == "ring") {
    // Logical Ring
    $type = "ring";
}
...
<table width="450" border="0 cellspacing=" 0" cellpadding="0">
    ...
    <tr>
        <td>Workstations :</td>
        <td align="left"><?php echo $_SESSION["star"]["workstations"]; ?></td>
    </tr>
    <tr>
        <td>Servers :</td>
        <td align="left"><?php echo $_SESSION["star"]["servers"]; ?></td>
    </tr>
    <tr>
        <td>Printers :</td>
        <td align="left"><?php echo $_SESSION["star"]["printers"]; ?></td>
    </tr>
</table>
<br />

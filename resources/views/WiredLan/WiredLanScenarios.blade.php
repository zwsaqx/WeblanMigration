            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="normalText">
                <tr>
                    <td> <span class="darkBlueTextJumbo"><a name="Scenario1"></a><strong>Scenario 1</strong></span><br />
                        ...
                        some network equipment in Auckland to provide a network for their Windows XP workstations and for
                        three servers: two NetWare servers (NET1) and (NET2) and one Windows 2003 server (WINS).
                        <blockquote>
                            <span class="darkBlueText">Auckland Office</span>
                            <br />All machines have Combo cards installed. The network must comply with the following
                            criteria:
                            <ul>
                                ...
                                <li>Each warehouse department has five users and one network-connected printer <br />(Total
                                    = 10 users; 2 printers).</li>
                                <li>Each office block department has six users and one network-connected printer
                                    <br />(Total = 12 users; 2 printers).
                                </li>
                                <li>The two sites (warehouse and office block) should be connected to one another using
                                    Ethernet switches.</li>
                                <li>NET1 (a NetWare server) should be located at the Warehouse.</li>
                                <li>NET2 (a NetWare server) and WINS (Windows 2003 server) should be located in the office
                                    block.</li>
                            </ul>
                        </blockquote>

                        <P><span class="redText">Question: </span>Draw a diagram detailing how KIL's new Auckland network
                            will
                            be set up. </P>
                ...
                <tr>
                    <td>
                        <p><span class="darkBlueTextJumbo"><a name="Scenario3"></a><strong>Scenario 3</strong></span><br />
                            ...
                            <img src="{{ asset('Images/Wired/2buildings.gif') }}" width="614" height="347">
                        </p>
                        ...
                        <P><span class="redText">Question: </span>Draw a detailed diagram of the
                            proposed network.</P>
                        <P><span class="redText">Answer: </span><img src="{{ asset('Images/Wired/scenario3_wired.jpg') }}"
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="normalText">
                <tr>
                    <td>
                        ...
                        <P><span class="redText">Answer: </span><img src="{{ asset('Images/Wired/scenario4_wired.jpg') }}"
                                width="600" height="500" align="top"></P>
                        <br />
                        <a href="#Top">[To Top]</a>
                    </td>

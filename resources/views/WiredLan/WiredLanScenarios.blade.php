...
<body>
    ...
    <h1><div align="center" class="darkBlueTextJumbo">Wired LAN Scenarios</div></h1>
<br />
  ...
  <tr>
	...
	<blockquote> 
      ...
      <P><span class="redText">Question: </span>Draw a diagram detailing how KIL's new Auckland network will 
        be set up. </P>
      <P><span class="redText">Answer: </span><img src="{{asset('Images/Wired/scenario1_wired.gif')}}" alt=""> width="600" height="500" align="top"></P>
      <br />
      <a href="#Top">[To Top]</a>
	</td>
  </tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="normalText">
  <tr> 
    <td> <span class="darkBlueTextJumbo"><a name="Scenario2"></a>Scenario 2</span><br />
      ...
      <P><span class="redText">Answer: </span><img src="{{asset('Images/Wired/scenario2_wired.jpg')}}" alt=""> align="top" width="600" height="500"></P>
	  <br />
      <a href="#Top">[To Top]</a>
	  </td>
  </tr>
  ...
  <tr> 
    <td> <p><span class="darkBlueTextJumbo"><a name="Scenario3"></a>Scenario 3</span><br />
      ...
      <P><span class="redText">Question: </span>Draw a detailed diagram of the 
        proposed network.</P>
      <P><span class="redText">Answer: </span><img src="{{asset('Images/Wired/scenario3_wired.jpg')}}" width="600" height="500" align="top"></P>
	  <br />
      <a href="#Top">[To Top]</a>
	  </td>
  </tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="normalText">
  <tr> 
    <td> <p><span class="darkBlueTextJumbo"><a name="Scenario4"></a>Scenario 4</span><br />
      ...
      <P><span class="redText">Answer: </span><img src="{{asset('Images/Wired/scenario4_wired.jpg')}}" width="600" height="500" align="top"></P>
	  <br />
      <a href="#Top">[To Top]</a>
	  </td>
  </tr>

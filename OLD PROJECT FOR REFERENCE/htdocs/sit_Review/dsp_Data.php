<DIV class=darkBlueTextJumbo align=center>Data Link Review Questions</DIV>
          ...
          <br />
		  <p><span class="darkBlueText">Question 2: </span>What is the difference between a straight-through and crossover cable? </p>
          <p><span class="redText">Answer:</span> A straight-through cable is used to connect two different devices together (Computers to switches, hubs). Crossover cable is used to connect two similar devices together.</p>
           <br />
          ...
          <p><span class="redText">Answer: </span>STP, UTP, coaxial,  fibre optic.</p>
           <br />
		  <p><span class="darkBlueText">Question 4: </span>What are the possible analog-to-analog modulation techniques?</p>
          <p><span class="redText">Answer:</span> Amplitude modulation, Phase modulation, Frequency modulation.</p>
           <br />
		  <p><span class="darkBlueText">Question 5:</span> What are the possible digital-to-analog modulation techniques? </p>
          ...
          <p><span class="redText">Answer: </span>Orange/white, orange, green/white, blue, blue/white, green, brown/white, brown at both ends of the cable.</p>
           <br />
          ...
          <p><span class="redText">Answer:</span> Noise is unwanted electrical or electromagnetic energy that degrades the quality of signals and data.</p>
           <br />
		  <p><span class="darkBlueText">Question 13:</span> What is asynchronous transmission? </p>
          <p><span class="redText">Answer: </span>The transmission of data in which each character is a self-contained unit with its own start and stop bits and an uneven interval between them.</p>
           <br />
		  <p><span class="darkBlueText">Question 14:</span> What is the purpose of cables being shielded and having twisted pairs?</p>
          ...
          <p><span class="redText">Answer: </span>A type of electromagnetic interference (noise) that affects data being transmitted.</p>
           <br />
		  <p><span class="darkBlueText">Question 16:</span> What is ICMP</p>
          <p><span class="redText">Answer:</span> Internet Control Message Protocol. It provides rules and standards for message communication in TCP/IP stack.</p>
           <br />
		  <p><span class="darkBlueText">Question 17:</span> What is the maximum distance that a fibre optic cable can take? </p>
          ...
          <p><span class="redText">Answer: </span>10 to 100 mbps.</p>
           <br />
		  <p><span class="darkBlueText">Question 19:</span> What is the common transmission rate of fibre optic cable? </p>
          <p><span class="redText">Answer: </span>Per channel speed: 100Gbit/s.</p>
           <br />
		  <p><span class="darkBlueText">Question 20: </span> What should you do if you want to transfer files between different platforms:</p>
          <p><span class="redText">Answer:</span> Using FTP (File Transfer Protocol) because it is platform independent.</p>
		  <br />
          ...
          <p><span class="redText">Answer:</span> The upper sublayer defines software processes, providing services to the network layer protocols. The Lower sublayer defines the media access processes performed by the hardware.</p>
           <br />
          ...
          <p><span class="redText">Answer: </span>Token ring, FDDI.</p>
           <br />
		  <p><span class="darkBlueText">Question 29:</span> What is the name given to addresses added at the Data Link Layer? </p>

...
<table width="500" border="0 cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<td align="left"><?php echo $_SESSION["adHoc"]["mobileWorkstations"]; ?></td

  </tr>
  <tr>
    <td>PDAs :</td>
    <td align="left"><?php echo $_SESSION["adHoc"]["pdas"]; ?></td>
  </tr>
  <tr>
    <td>Printers :</td>
    <td align="left"><?php echo $_SESSION["adHoc"]["printers"]; ?></td>
  </tr>
</table>
<br />
...
<table border="0" spacing="0" padding="0">
  <tr>
    ...
    <td width="60" align="center"><?php if ($totalDevices >= 21) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
  ...
  <tr>
    ...
    <td width="60"><?php if ($totalDevices >= 6) { echo(COMM_DIAG2);} elseif ($totalDevices >= 5) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); } ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 6) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
    ...
    <td width="60"><?php if ($totalDevices >= 22) { echo(COMM_DIAG2);} elseif (($totalDevices >= 21)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); } ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 22) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
  </tr>
  <tr>
    ...
    <td width="60" align="center"><?php if ($totalDevices >= 6) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
    ...
    <td width="60" align="center"><?php if ($totalDevices >= 22) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
    <td width="60"><?php echo($deviceLayout[21]); ?></td>
  </tr>
  <tr>
    <td align="center"><?php if ($totalDevices >= 7) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
    <td><?php if ($totalDevices >= 8) { echo(COMM_DIAG2);} elseif (($totalDevices >= 7)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); } ?></td>
    ...
    <td><?php if ($totalDevices >= 23) { echo(COMM_DIAG2);} elseif (($totalDevices >= 22)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); } ?></td>
    <td align="center"><?php if ($totalDevices >= 23) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
  </tr>
  <tr>
    <td><?php echo($deviceLayout[6]); ?></td>
    ...
    <td align="center"><?php if ($totalDevices >= 23) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
    <td><?php echo($deviceLayout[22]); ?></td>
  </tr>
  <tr>
    ...
    <td><?php if ($totalDevices >= 24) { echo(COMM_DIAG2);} elseif (($totalDevices >= 23)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); }?></td>
    <td align="center"><?php if ($totalDevices >= 24) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
  </tr>
  <tr>
    ...
    <td align="center"><?php if ($totalDevices >= 24) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
    <td><?php echo($deviceLayout[23]); ?></td>
  </tr>
    <tr>
    <td align="center"><?php if ($totalDevices >= 17) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
    <td><?php if ($totalDevices >= 18) { echo(COMM_DIAG2);} elseif (($totalDevices >= 17)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); } ?></td>
    <td align="center"><?php if ($totalDevices >= 18) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
    ...
    <td><?php if ($totalDevices >= 25) { echo(COMM_DIAG2);} elseif (($totalDevices >= 24)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); } ?></td>
    <td align="center"><?php if ($totalDevices >= 25) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
  </tr>
  <tr>
    <td><?php echo($deviceLayout[16]); ?></td>
    <td align="center"><?php if ($totalDevices >= 18) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
    <td><?php echo($deviceLayout[17]); ?></td>
    ...
    <td align="center"><?php if ($totalDevices >= 25) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
    <td><?php echo($deviceLayout[24]); ?></td>
  </tr>
  <tr>
    <td align="center"><?php if ($totalDevices >= 26) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
    <td><?php if ($totalDevices >= 27) { echo(COMM_DIAG2);} elseif (($totalDevices >= 26)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); } ?></td>
    <td align="center"><?php if ($totalDevices >= 27) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
    <td><?php if ($totalDevices >= 28) { echo(COMM_DIAG2);}  elseif (($totalDevices >= 27)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); }?></td>
    <td align="center"><?php if ($totalDevices >= 28) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
    <td><?php if ($totalDevices >= 29) { echo(COMM_DIAG2);} elseif (($totalDevices >= 28)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); } ?></td>
    <td align="center"><?php if ($totalDevices >= 29) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
    <td><?php if ($totalDevices >= 30) { echo(COMM_DIAG2);} elseif (($totalDevices >= 29)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); }?></td>
    <td align="center"><?php if ($totalDevices >= 30) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
  </tr>
  <tr>
    <td><?php echo($deviceLayout[25]); ?></td>
    <td align="center"><?php if ($totalDevices >= 27) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
    <td><?php echo($deviceLayout[26]); ?></td>
    <td align="center"><?php if ($totalDevices >= 28) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
    <td><?php echo($deviceLayout[27]); ?></td>
    <td align="center"><?php if ($totalDevices >= 29) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
    <td><?php echo($deviceLayout[28]); ?></td>
    <td align="center"><?php if ($totalDevices >= 30) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>

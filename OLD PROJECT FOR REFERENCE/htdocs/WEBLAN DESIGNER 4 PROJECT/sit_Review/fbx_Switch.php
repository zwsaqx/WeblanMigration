...
switch($Fusebox["fuseaction"]) {
  ...
  case "Fusebox.defaultFuseaction":
    ...
    break;
  case "wired":
    $Title = 'WebLan-Designer Wired LAN Review Questions';
    include("dsp_Wired.php");
    break;
  case "wireless":
    $Title = 'WebLan-Designer Wireless LAN Review Questions';
    include("dsp_Wireless.php");
    break;
	case "tcpip":
    $Title = 'WebLan-Designer TCP/IP Review Questions';
    include("dsp_TCPIP.php");
    break;
  case "bluetooth":
      $Title = 'WebLan-Designer Bluetooth Networking Review Questions';
      include("dsp_Bluetooth.php");
      break;
  case "data":
    $Title = 'WebLan-Designer Data Communication Review Questions';

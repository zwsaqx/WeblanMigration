...
if (($_SESSION[QUIZ_TYPE] != WIRELESS)||($_SESSION[QUIZ_STATUS] == INITIALIZING)) {
  // Define the quiz range
  $_SESSION["quizSettings"] = getQuizSettings();
  $_SESSION[QUIZ_TYPE] = WIRELESS;
  $_SESSION["quizPage"] = 0;

  // Fetch the questions
  $_SESSION["quizQuestions"] = initQuiz(WIRELESS, $_SESSION["quizSettings"]["tot"]);
...
<DIV class=darkBlueTextJumbo align=center>Wireless LAN Quiz</DIV>
<br />

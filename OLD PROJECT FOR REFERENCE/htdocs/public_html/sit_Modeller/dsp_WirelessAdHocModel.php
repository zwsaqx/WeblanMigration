...
<table border="0" spacing="0" padding="0">
  ...
  <tr>
    ...
    <td width="60"><?php if ($totalDevices >= 8) { echo(COMM_DIAG2);} elseif (($totalDevices >= 6)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); } ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 8) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
    <td width="60"><?php if ($totalDevices >= 9) { echo(COMM_DIAG2);} elseif (($totalDevices >= 8)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); } ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 9) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
    <td width="60"><?php if ($totalDevices >= 15) { echo(COMM_DIAG2);} elseif (($totalDevices >= 14)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); } ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 15) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
    <td width="60"><?php if ($totalDevices >= 19) { echo(COMM_DIAG2);} elseif (($totalDevices >= 18)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); } ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 19) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
  </tr>
  <tr>
    <td width="60"><?php echo($deviceLayout[5]); ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 8) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
    <td width="60"><?php echo($deviceLayout[7]); ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 9) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
    <td width="60"><?php echo($deviceLayout[8]); ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 15) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
    <td width="60"><?php echo($deviceLayout[14]); ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 19) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
    <td width="60"><?php echo($deviceLayout[18]); ?></td>
  </tr>
  <tr>
    <td width="60" align="center"><?php if ($totalDevices >= 10) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
    <td width="60"><?php if ($totalDevices >= 11) { echo(COMM_DIAG2);} elseif (($totalDevices >= 10)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); } ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 11) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
    <td width="60"><?php if ($totalDevices >= 12) { echo(COMM_DIAG2);} elseif (($totalDevices >= 11)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); } ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 12) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
    <td width="60"><?php if ($totalDevices >= 16) { echo(COMM_DIAG2);} elseif (($totalDevices >= 15)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); } ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 16) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
    <td width="60"><?php if ($totalDevices >= 20) { echo(COMM_DIAG2);} elseif (($totalDevices >= 19)) { echo(COMM_DIAG1); }  else { echo ("&nbsp;"); } ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 20) { echo(COMM_VERT); } else { echo ("&nbsp;"); } ?></td>
  </tr>
  <tr>
    <td width="60"><?php echo($deviceLayout[9]); ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 11) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
    <td width="60"><?php echo($deviceLayout[10]); ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 12) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
    <td width="60"><?php echo($deviceLayout[11]); ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 16) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>
    <td width="60"><?php echo($deviceLayout[15]); ?></td>
    <td width="60" align="center"><?php if ($totalDevices >= 20) { echo(COMM_HORIZ); } else { echo ("&nbsp;"); } ?></td>

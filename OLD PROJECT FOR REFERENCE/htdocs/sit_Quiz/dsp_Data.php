...
if (($_SESSION[QUIZ_TYPE] != DataCom)||($_SESSION[QUIZ_STATUS] == INITIALIZING)) {
  // Define the quiz range
  $_SESSION["quizSettings"] = getQuizSettings();
  $_SESSION[QUIZ_TYPE] = DataCom;
  $_SESSION["quizPage"] = 0;

  // Fetch the questions
  $_SESSION["quizQuestions"] = initQuiz(DataCom, $_SESSION["quizSettings"]["tot"]);
...
<div align="center" class="darkBlueTextJumbo">Data Link Protocol Quiz</div>
<br />

...
if (($_SESSION[QUIZ_TYPE] != TCPIP)||($_SESSION[QUIZ_STATUS] == INITIALIZING)) {
  // Define the quiz range
  $_SESSION["quizSettings"] = getQuizSettings();
  $_SESSION[QUIZ_TYPE] = TCPIP;
  $_SESSION["quizPage"] = 0;

  // Fetch the questions
  $_SESSION["quizQuestions"] = initQuiz(TCPIP, $_SESSION["quizSettings"]["tot"]);
...
<div align="center" class="darkBlueTextJumbo">TCP/IP Networking Quiz</div>
<br />

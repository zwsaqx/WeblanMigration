...
<div class="row">
  <div class="large-12 columns">
    <h2>Welcome to XAMPP for Windows 5.6.14</h2>
  </div>
</div>
<div class="row">
  <div class="large-12 columns">
    <p>
      translation missing: en.You have successfully installed XAMPP on this system! Now you can start using Apache, MariaDB, PHP and other components.

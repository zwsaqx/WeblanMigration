...
switch($Fusebox["fuseaction"]) {
  ...
  case "Fusebox.defaultFuseaction":
    ...
    break;
  case "wired":
    $Title = 'WebLan-Designer Wired LAN Key Terms';
    include("dsp_Wired.php");
    break;
  case "wireless":
    $Title = 'WebLan-Designer Wireless LAN Key Terms';
    include("dsp_Wireless.php");
    break;
	case "tcpip":
    $Title = 'WebLan-Designer TCP/IP Key Terms';
    include("dsp_TCPIP.php");
    break;
  case "bluetooth":
      $Title = 'WebLan-Designer Bluetooth Networking Key Terms';
      include("dsp_Bluetooth.php");
      break;
  case "data":
    $Title = 'WebLan-Designer Data Communication Key Terms';
